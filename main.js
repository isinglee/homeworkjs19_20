...
// Get everyone's unique skills (sorted)
// Use toLowerCase() for case insensitive sorting
var result = _.sortBy(_.uniq(_.flatten(_.map(data, 'skills'))), function (i) { return i.toLowerCase(); });
console.log("Get everyone's unique skills (sorted): \n", result);

// People's names sorted by friends count
var result = _.map(_.sortBy(data, function (i) { return i.friends.length; }), 'name');
console.log("People's names sorted by friends count: \n", result);


// Everyone's unique friends
var result = _.uniq(_.map(_.flatten(_.map(data, 'friends')), 'name'));
console.log("Everyone's unique friends: \n", result);
